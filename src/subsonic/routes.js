...
export async function registerSubsonicRoutes(app) {
  app.get('/rest/ping.view', async (request, reply) => proxyToNavidrome(request, reply));
  app.get('/rest/ping', async (request, reply) => proxyToNavidrome(request, reply));

  app.get('/rest/getLicense.view', async (request, reply) => proxyToNavidrome(request, reply));
  app.get('/rest/getLicense', async (request, reply) => proxyToNavidrome(request, reply));
